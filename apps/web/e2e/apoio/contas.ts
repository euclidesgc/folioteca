...
// `espacos.spec.ts` precisam do mesmo caminho que `instalacao.setup.ts` grava.
...
export const ARQUIVO_COLEGA = path.join(PASTA_DE_ESTADO, "colega.json");
...
// testariam nada que duas não testem. A colega (plano 05) é a terceira pessoa
// fixa: o convite de espaço restrito precisa de alguém que não administra,
// não criou o espaço e não foi convidada ainda.
