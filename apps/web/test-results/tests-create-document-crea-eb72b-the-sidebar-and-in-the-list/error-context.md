...
- Name: tests/create-document.spec.ts >> creates a document from the keyboard, renames it and finds it in the sidebar and in the list
- Location: tests/create-document.spec.ts:25:1
...
```ts
  ...
  2   | 
  3   | import { expectNoSeriousA11yViolations } from '../a11y';
  4   | 
