...
- [ ] T1.1 — Contrato e tabela do compartilhamento com a instância (D1, D2, D3, R2, R3)
...
- [ ] T1.2 — A instância entra no caminho único de acesso (D4, R4, R5, R6, R7)
...
- [ ] T1.3 — Rota e serviço do compartilhamento com a instância; lista com `instance` (D2, D3, R1, R2, R3, R6, R7)
...
- [ ] T2.1 — Chamada, tipo da lista e API simulada da instância (D2, D3, D5)
...
- [ ] T2.2 — Grupo "Compartilhar com" no painel e linha "Todos da organização" na lista (D5, D6, R1, R3, R8, R9)
