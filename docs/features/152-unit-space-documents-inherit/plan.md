...
- [ ] T1.1 — Contrato sem o 403 do herdado (D4, R1, R2, R11)
...
- [ ] T1.2 — A regra de alcance mora em `access` e amplia a decisão de documento (D1, D2, D3, R3–R7)
...
- [ ] T1.3 — `spaces` e `documents` usam a regra única (D1, D3, D4, D5, R1, R2, R4, R8, R10, R11)
...
- [ ] T2.1 — API simulada trata o herdado como o direto (D6)
...
- [ ] T2.2 — Some o aviso de lotação direta da lista do espaço (D6, R1, R12)
