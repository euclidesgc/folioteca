...
- [ ] T1.1 — Contrato primeiro: `GET /spaces` e os schemas `Space` e `SpacesResponse`
...
- [ ] T1.2 — Módulo `spaces`: serviço com escopo de sessão e lotação direta, controller com `SessionGuard` na classe
