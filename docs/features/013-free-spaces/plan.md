...
- [ ] T1.1 — Contrato primeiro: `post` em `/spaces`, `CreateSpaceInput`, `SpaceResponse` e `type: free`
...
- [ ] T1.2 — Banco: colunas do espaço livre, migration 0013 escrita à mão e esquema Prisma
...
- [ ] T1.3 — Módulo `spaces`: schema do nome, `create` e `list` com espaços livres, `@Post()` no controller
...
- [ ] T2.1 — Renomear a feature `unit-spaces` para `spaces`, a rota e o caminho
...
- [ ] T2.2 — API simulada, schema do nome e mutação `useCreateSpace`
...
- [ ] T2.3 — Seção "Espaços" com o diálogo "Novo espaço" sempre montado
...
- [ ] T2.4 — Página do espaço generalizada por tipo e foco no `<main>` após criar
...
- [ ] T2.5 — Testes da fase 2 e os e2e antigos afetados
