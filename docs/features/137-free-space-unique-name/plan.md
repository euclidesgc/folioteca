...
- [x] T1.1 — Índice único parcial no banco e `isUniqueViolation` compartilhado
...
- [x] T1.2 — `SpacesService.create` recusa com 409 e contrato documenta
