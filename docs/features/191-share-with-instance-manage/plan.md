...
- [ ] T2.1 — Chamada de remoção e API simulada (D5)
...
- [ ] T2.2 — Seletor de nível e remoção na linha "Todos da organização" (D3, D4, D5, R1, R2, R3, R6, R7)
