...
| Ações do nó da árvore | `<div data-tree-actions className="flex shrink-0 items-center gap-1">` depois do rótulo, na linha do nó; botões `ghost` + `size="icon"`; sempre visíveis (nunca só no `hover`) | 065 |
